...
class TrascrizioneStandalone extends StatefulWidget {
  const TrascrizioneStandalone({super.key});

  @override
  State<TrascrizioneStandalone> createState() => TrascrizioneStandaloneState();
}

class TrascrizioneStandaloneState extends State<TrascrizioneStandalone> {
  @override
  initState() {
    super.initState();
            ...
            child: Padding(
                ...
                child: Padding(
                  ...
                  child: ChangeNotifierProvider(
                      ...
                      child: const TrascrizioneAudioVideoMain()),
                )),
          );
        }
      },
