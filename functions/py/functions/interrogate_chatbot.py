...
class Interrogate_Chatbot:
    ...
    def get_messages_from_thread(
        self, thread_id: str, run_id: str, timeout: int
    ) -> list:
        ...
        messages_text = self.get_messages_texts(
            latest_assistant_messages=latest_assistant_messages
        )

        return messages_text

    def process_interrogation(
        self, assistant_name: str, assistant_id: str, message: str, thread_id: str
    ) -> list[str]:
